# Author: Xuedan Zou
# Date: 10/27/2021
# this is almost the code that provided
...
class Sudoku:
    ...
    # change itself from the .sol file
    ...
    # convert r,c,v to the cnf clues +/-rcv
    ...
    # for each block, values from 1 to 9
    ...
    # generate the cnf for a given sudoku file
